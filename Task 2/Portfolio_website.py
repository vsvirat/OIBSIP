   ...
   <div class="container">
      <div class="row">
          <div class="col-lg-6 col-md-6 col-ms-12 col-xs-12">
              <h3>Hi There,</h3>
              <h1>I<span style="color:rgb(231, 86, 33);">'</span>m Vivek Singh</h1>
              <h2>Python and ML enthusiast</h2>
         ...
         <div class="container">
              <div class="row m-0">
                   <div class="col-lg-6 col-md-6 col-ms-12 col-xs-12">
                         ...
                         <h4 id="vaishnavipriyanshu198_gmail">vsvirat24@gmail.com</h4>
                         <div class="contact_info">
                              <h5>LinkedIn:Vivek Singh</h5>
                              <h5>Github: vsvirat</h5>
                   ...
                   <div class="col-lg-6 col-md-6 col-ms-12 col-xs-12 about_me_right_section">
                        ...
                        <hr>
                        <p id="txt">Hello, I'm Vivek Singh, a Computer Science Engineering student. I am a passionate programmer and ML enthusiast. I worked as a Web development Intern at Oasis Infobyte. Love to do coding leetcode that helps me to develop my Problem Solving skills.</p>
                        <table class="table">
                             <tr>
                                  <td>Name</td>
                                  <td>:</td>
                             ...
                             <tr>
                                <td>Email</td>
                                <td>:</td>
                                <td>vsvirat24@gmail.com</td>
                             </tr>
                             <tr>
                                <td>College</td>
                                <td>:</td>
                                <td>Pranveer Singh Insitute of Technology</td>
                           </tr>
                        </table>
      ...
      <section class="certificates" id="certificates">
              ...
              <!-- <h1 class="heading"> My <span>Certificates</span></h1> -->
               <div class="box-container">
                 ...
                 <div class="box">
                     <img src="Screenshot 2024-09-19 171816.png" alt="">
                </div>

                <div class="box">
                    <img src="Screenshot 2024-09-19 175103.png" alt="">
                </div>

                <div class="box">
                    <img src="Screenshot 2024-09-19 171951.png" alt="">
                </div>

                <div class="box">
                    <img src="Screenshot 2024-09-19 172026.png" alt="">
                </div>

                <div class="box">
                    <img src="Screenshot 2024-09-19 173053.png" alt="">
                </div>

                <div class="box">
                    <img src="Screenshot 2024-09-19 171855.png" alt="">
                </div>
            ...
            <div class="box-container">
                ...
                <div class="box">
                   <div class="content">
                       ...
                       <p> I got selected as a Web Developer Intern @OasisInfobyte. This is a 1-month Virtual Internship Program where I got the opportunity to work on multiple tasks and even got the chance to apply my skills and knowledge to make websites fun!</p>
                   </div>
                ...
                <div class="box">
                    <div class="content">
                        <span> July 2020 - Septemper 2020 </span>
                        <h3>Product Engineering Internship at Vestige, India</h3>
                        <p> Manage product development cycles - requirement, prototype and production. Studied and documented the processes in product development. </p>
                    </div>  
                </div>
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                       <div>
                            <ul class="list-unstyled">
                                <li>
                                    <i class="fa fa-envelope-o"></i> vs35536@gmail.com
                                </li>

                                <li>
                                    <i class="fa fa-phone"></i> +91 7493958014
                                </li>

                                <li>
                                    <i class="fa fa-bars"></i> Mirzapur, India-247667
                                </li>
          ...
          <div class="container">
               <div class="row py-5">
                   <div class="logo-area col-lg-4 col-md-4 col-sm-12 col-12">
                          ...
                          <a class="navbar-brand text-white" href="#">
                              Vivek Singh <span style="color: orangered;"></span>
                          </a>
